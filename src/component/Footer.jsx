...
const Footer = () => {
  return (
    <>
      <footer className="bg-white absolute w-full bottom-0 rounded-lg shadow sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 dark:bg-gray-800 antialiased">
